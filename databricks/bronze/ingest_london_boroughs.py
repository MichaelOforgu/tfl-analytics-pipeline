...
# Base volume and paths for raw data, checkpoints, and schema evolution
source_subdir = "boroughs"
target_table = "boroughs_bz"
...
def ingest_london_boroughs(once=True, processing_time="5 seconds"):
...
ingest_london_boroughs(once=True, processing_time="5 seconds")
